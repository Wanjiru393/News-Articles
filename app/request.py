...
import json  
#  connection to our API URL and send a request
...
def get_sources():
    ...
    '''
    get_sources_url = 'http://newsapi.org/v2/sources?&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(
        api_Key) 
...
def get_top_articles(id):
    ...
    Function that gets the json response to our url request
    '''
    get_articles_url = 'http://newsapi.org/v2/top-headlines?sources={}&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(
        id, api_Key)  # construct the top articles api url
    ...
    for articles_item in articles_list:
        ...
        if imageurl:
            articles_object = Articles(
                author, title, imageurl, publishedAt, url)
            articles_results.append(articles_object)
    return articles_results


def get_keyword(keyword_name):
    search_keyword_url = 'https://newsapi.org/v2/everything?q={}&sortBy=relevancy,publishedAt&pageSize=30&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(
        keyword_name, api_Key)
...
def get_breaking_news():
    get_breaking_news_url = 'http://newsapi.org/v2/top-headlines?country=us&category=general&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(
        api_Key)
